...
The homicide data consists of the following variables: `r ls(homicide_data)`. There are `r nrow(homicide_data)` observations. 
...
```{r}
city_nest = nest(homicide_data_summarized, total_homicides:unsolved_homicides)

results = map(city_nest, prop_unsolved_each_city)
