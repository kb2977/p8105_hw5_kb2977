...
![](p8105_hw5_kb2977_files/figure-markdown_github/plot_data-1.png)
...
Creating a city\_state variable (e.g. “Baltimore, MD”) and then summarize within cities to obtain the total number of homicides and the number of unsolved homicides (those for which the disposition is “Closed without arrest” or “Open/No arrest”).
...
``` r
homicide_data = read_csv(file = "./homicide_data/homicide_data.csv")
```
